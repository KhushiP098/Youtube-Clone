...
const SuggestionVideoCard = ({video}) => {
  ...
  <div className='flex mb-3'>
    ...
    <div className='relative h-24 lg:h-29 xl:h-24 w-40 min-w-[169px] lg:w-32 lg:min-w-[128px] xl:w-40 xl:min-w-[168px] rounded-xl  bg-slate-800  overflow-hidden'>
     <img 
    ...
    <div className='flex flex-col ml-3 overflow-hidden'>
        <span className="text-sm lg:text-xs xl:text-sm font-bold line-clamp-2 text-white">
         ...
         <span className='text-[12px] lg:text-[10px] xl:text-[12px] font-semibold text-white/[0.7] flex items-center'>
          {video?.author?.title} 
